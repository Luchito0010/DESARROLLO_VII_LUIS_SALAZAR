...
echo "\nValor total del inventario: $" . valorTotalInventario($inventario) . "<br><br>";
...
$productoMayor = productoMayorValor($inventario);
if ($productoMayor !== null) {
    echo "El producto con el mayor valor total en inventario es: $productoMayor con un valor de: $" . ($inventario[$productoMayor]['cantidad'] * $inventario[$productoMayor]['precio']);
} else {
