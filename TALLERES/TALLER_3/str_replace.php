...
$miFrase = "PHP es un leguaje de progrmacion pero PHP no es el lenguaje de programacion por lo tanto PHP es un solo un lenguaje de programacion"; // Reemplaza esto con tu frase
