...
$misAmigos = ["luis","beno","mario"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "sam", "bismar"); // Reemplaza las comillas vacías con los nombres de tus amigos
